...
if __name__ == "__main__":
    input_dir = "/workspace/Automatic-Audio-Dataset-Maker/FILTERED_PARQUET"
    output_audio_dir = "/workspace/Automatic-Audio-Dataset-Maker/FILTERED_PARQUET" + "/FINAL_WAVS"
    output_csv_dir = "/workspace/Automatic-Audio-Dataset-Maker/FILTERED_PARQUET" + "/CSV"
